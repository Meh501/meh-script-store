...
const app = express();
// إعداد المجلد الرئيسي للملفات بشكل احترافي للسيرفر
...
(async () => {
    // فتح قاعدة البيانات في المسار الصحيح
    ...
    console.log("✅ متجر Meh العالمي شغال!");
})();

// روابط الصفحات بشكل مباشر لضمان عدم حدوث "Not Found"
...
app.post('/register', async (req, res) => {
    ...
    if (username.length < 3 || password.length < 8) return res.json({ success: false, message: "⚠️ البيانات غير مستوفية للشروط" });
    try {
...
// تشغيل السيرفر على البورت اللي يختاره Render أو 3000
