...
(async () => {
    ...
    console.log("✅ سيرفر المالك Meh يعمل بنجاح!");
})();
...
// الأمر الجديد: جلب كل الأكواد وحالتها
...
// باقي العمليات (تفعيل، تقييمات، تحديثات)
app.post('/activate', async (req, res) => {
    ...
    } else res.json({ success: false, message: "كود خاطئ أو مستخدم مسبقاً!" });
});
